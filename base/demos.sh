...
python ann.py --dataset STL10 --batch_size 1 --architecture mobilenet-lip-1222121 --im_size 128 --epochs 1 --devices 0 --seed 0 --test_only --visualize --pretrained_ann ./trained_models_ann/mobilenet-lip-1222121/mobilenet-lip-1222121_stl10_imsize128.pth