...
python ann.py --dataset STL10 --batch_size 8 --architecture PREPOOL-RESNET18-MAXP-4 --learning_rate 1e-2 --epochs 300 --lr_interval '0.6 0.8 0.9' --lr_reduce 5 --optimizer SGD --dropout 0.2 --devices 0,1 --seed 0 --log
