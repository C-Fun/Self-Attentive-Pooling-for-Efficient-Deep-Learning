...
class Dynamic_conv3d(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size, stride=1, padding=0, ratio=0.25, dilation=1, groups=1, bias=True, K=4, temperature=34):
...
if __name__ == '__main__':
    ...
    model = Dynamic_conv1d(in_planes=3, out_planes=16, kernel_size=3, stride=1, padding=1, ratio=0.25)
    x = x.to('cuda:0')
    model.to('cuda')
