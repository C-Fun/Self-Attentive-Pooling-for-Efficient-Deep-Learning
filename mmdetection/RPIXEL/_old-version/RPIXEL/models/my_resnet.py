...
from RPIXEL.models.dynamic_models.dynamic_conv import Dynamic_conv2d
from RPIXEL.models.dynamic_models.dy_resnet import conv1x1, BasicBlock, Bottleneck

from RPIXEL.models.pool_models.pool_models import MultiheadAttnPool as Pooling2d
...
class ResNet(BaseModule):
	...
	def __init__(self, block, layers, zero_init_residual=False,
		...
		self.pool2 = Pooling2d(128*block.expansion, kernel_size=2, stride=2, patch_size=32, embed_dim=8, num_heads=2)

		self.layer3 = self._make_layer(block, 256, layers[2], stride=1,
									   dilate=replace_stride_with_dilation[1])
		self.pool3 = Pooling2d(256*block.expansion, kernel_size=2, stride=2, patch_size=16, embed_dim=8, num_heads=2)

		self.layer4 = self._make_layer(block, 512, layers[3], stride=1,
									   dilate=replace_stride_with_dilation[2])
		self.pool4 = Pooling2d(512*block.expansion, kernel_size=2, stride=2, patch_size=8, embed_dim=8, num_heads=2)
	...
	def forward(self, x):
		return tuple(self._forward_impl(x))
