...
class DynamicConvolution(TempModule):
    def __init__(self, in_channels, out_channels, kernel_size,
                 stride=1, padding=0, dilation=1, groups=1, bias=True, nof_kernels=4, reduce=4):
        """
...
class FlexibleKernelsDynamicConvolution:
    ...
    def __call__(self, *args, **kwargs):
        return self.Base(nof_kernels=next(self.nof_kernels_it), reduce=self.reduce, *args, **kwargs)
