...
from .pool_models.pool_models import LIP2d
...
class ResNet(nn.Module):
	...
	def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
		...
		self.pool2 = LIP2d(128*block.expansion, kernel_size=2, stride=2)

		self.layer3 = self._make_layer(block, 256, layers[2], stride=1,
									   dilate=replace_stride_with_dilation[1])
		self.pool3 = LIP2d(256*block.expansion, kernel_size=2, stride=2, padding=0)

		self.layer4 = self._make_layer(block, 512, layers[3], stride=1,
									   dilate=replace_stride_with_dilation[2])
		self.pool4 = LIP2d(512*block.expansion, kernel_size=2, stride=2, padding=0)
...
class ResNet50_LIP(nn.Module):
	def __init__(self, pretrained=False, pth_file=None, **kwargs):
		super(ResNet50_LIP, self).__init__()
