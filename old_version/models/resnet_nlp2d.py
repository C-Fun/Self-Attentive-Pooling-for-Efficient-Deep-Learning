...
from .pool_models.pool_models import NLP2d
...
class ResNet(nn.Module):
	...
	def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
		...
		self.pool2 = NLP2d(128*block.expansion, kernel_size=2, stride=2, patch_size=1, embed_dim=None, num_heads=2)

		self.layer3 = self._make_layer(block, 256, layers[2], stride=1,
									   dilate=replace_stride_with_dilation[1])
		self.pool3 = NLP2d(256*block.expansion, kernel_size=2, stride=2, patch_size=1, embed_dim=None, num_heads=4)

		self.layer4 = self._make_layer(block, 512, layers[3], stride=1,
									   dilate=replace_stride_with_dilation[2])
		self.pool4 = NLP2d(512*block.expansion, kernel_size=2, stride=2, patch_size=1, embed_dim=None, num_heads=8)
...
class ResNet50_NLP(nn.Module):
	def __init__(self, pretrained=False, pth_file=None, **kwargs):
		super(ResNet50_NLP, self).__init__()
